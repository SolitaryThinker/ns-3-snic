...
#ifndef SNIC_SOCKET_IMPL_H
#define SNIC_SOCKET_IMPL_H
...
class SnicSocketImpl : public SnicSocket
{
  public:
    /**
  ...
  private:
     ...
     */
    friend class SnicSocketFactory;
