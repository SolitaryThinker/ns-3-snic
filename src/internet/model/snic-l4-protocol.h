...
#ifndef SNIC_L4_PROTOCOL_H
#define SNIC_L4_PROTOCOL_H
 ...
 */
class SnicL4Protocol : public IpL4Protocol
{
  public:
    /**
    ...
    SnicL4Protocol(const SnicL4Protocol&) = delete;
    SnicL4Protocol& operator=(const SnicL4Protocol&) = delete;
    ...
    /**
     * \return A smart Socket pointer to a SnicSocket, allocated by this instance
     * of the SnicProtocol
     */
  ...
  private:
    ...
    std::vector<Ptr<SnicSocketImpl>> m_sockets;      //!< list of sockets
