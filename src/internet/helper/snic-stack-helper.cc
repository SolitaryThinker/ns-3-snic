...
NS_LOG_COMPONENT_DEFINE("SnicStackHelper");
...
SnicStackHelper::SnicStackHelper()
    : m_routing(nullptr),
      m_routingv6(nullptr),
      m_ipv4Enabled(true),
      m_ipv6Enabled(true),
...
SnicStackHelper::SnicStackHelper(const SnicStackHelper& o)
{
...
SnicStackHelper&
SnicStackHelper::operator=(const SnicStackHelper& o)
{
    if (this == &o)
    {
        return *this;
...
void
SnicStackHelper::SetRoutingHelper(const Ipv4RoutingHelper& routing)
{
    delete m_routing;
...
void
SnicStackHelper::SetRoutingHelper(const Ipv6RoutingHelper& routing)
{
    delete m_routingv6;
...
void
SnicStackHelper::SetIpv4StackInstall(bool enable)
{
    m_ipv4Enabled = enable;
}

void
SnicStackHelper::SetIpv6StackInstall(bool enable)
{
    m_ipv6Enabled = enable;
}

void
SnicStackHelper::SetIpv4ArpJitter(bool enable)
{
    m_ipv4ArpJitterEnabled = enable;
}

void
SnicStackHelper::SetIpv6NsRsJitter(bool enable)
{
    m_ipv6NsRsJitterEnabled = enable;
}

int64_t
SnicStackHelper::AssignStreams(NodeContainer c, int64_t stream)
{
...
void
SnicStackHelper::SetTcp(const std::string tid)
{
    m_tcpFactory.SetTypeId(tid);
}

void
SnicStackHelper::Install(NodeContainer c) const
{
    for (NodeContainer::Iterator i = c.Begin(); i != c.End(); ++i)
    {
        Install(*i);
...
void
SnicStackHelper::InstallAll() const
{
    Install(NodeContainer::GetGlobal());
}

void
SnicStackHelper::CreateAndAggregateObjectFromTypeId(Ptr<Node> node, const std::string typeId)
{
...
void
SnicStackHelper::Install(Ptr<Node> node) const
{
    if (m_ipv4Enabled)
    {
        if (node->GetObject<Ipv4>())
        {
            NS_FATAL_ERROR("SnicStackHelper::Install (): Aggregating "
                           "an SnicStack to a node with an existing Ipv4 object");
            return;
        }
    ...
    if (m_ipv6Enabled)
    {
        ...
        {
            NS_FATAL_ERROR("SnicStackHelper::Install (): Aggregating "
                           "an SnicStack to a node with an existing Ipv6 object");
            return;
        }
    ...
    if (m_ipv4Enabled || m_ipv6Enabled)
    {
        ...
        CreateAndAggregateObjectFromTypeId(node, "ns3::SnicL4Protocol");
...
void
SnicStackHelper::Install(std::string nodeName) const
{
...
bool
SnicStackHelper::PcapHooked(Ptr<Ipv4> ipv4)
{
...
void
SnicStackHelper::EnablePcapIpv4Internal(std::string prefix,
                                        Ptr<Ipv4> ipv4,
                                        uint32_t interface,
                                        bool explicitFilename)
{
    ...
    if (!PcapHooked(ipv4))
    {
        ...
        NS_ASSERT_MSG(ipv4L3Protocol,
                      "SnicStackHelper::EnablePcapIpv4Internal(): "
...
bool
SnicStackHelper::PcapHooked(Ptr<Ipv6> ipv6)
{
...
void
SnicStackHelper::EnablePcapIpv6Internal(std::string prefix,
                                        Ptr<Ipv6> ipv6,
                                        uint32_t interface,
                                        bool explicitFilename)
{
    ...
    if (!PcapHooked(ipv6))
    {
        ...
        NS_ASSERT_MSG(ipv6L3Protocol,
                      "SnicStackHelper::EnablePcapIpv6Internal(): "
...
bool
SnicStackHelper::AsciiHooked(Ptr<Ipv4> ipv4)
{
...
void
SnicStackHelper::EnableAsciiIpv4Internal(Ptr<OutputStreamWrapper> stream,
                                         std::string prefix,
                                         Ptr<Ipv4> ipv4,
                                         uint32_t interface,
                                         bool explicitFilename)
{
    ...
    if (!stream)
    {
        ...
        if (!AsciiHooked(ipv4))
        {
            ...
            NS_ASSERT_MSG(result == true,
                          "SnicStackHelper::EnableAsciiIpv4Internal():  "
...
bool
SnicStackHelper::AsciiHooked(Ptr<Ipv6> ipv6)
{
...
void
SnicStackHelper::EnableAsciiIpv6Internal(Ptr<OutputStreamWrapper> stream,
                                         std::string prefix,
                                         Ptr<Ipv6> ipv6,
                                         uint32_t interface,
                                         bool explicitFilename)
{
    ...
    if (!stream)
    {
        ...
        if (!AsciiHooked(ipv6))
        {
            ...
            NS_ASSERT_MSG(result == true,
                          "SnicStackHelper::EnableAsciiIpv6Internal():  "
