#ifndef SNIC_STACK_HELPER_H
#define SNIC_STACK_HELPER_H
 ...
 * \defgroup snic Snic
 *
 * This section documents the API of the ns-3 snic module. For a generic functional description,
 ...
 *
 * This helper enables pcap and ascii tracing of events in the snic stack
 ...
 */
class SnicStackHelper : public PcapHelperForIpv4,
                        ...
                        public AsciiTraceHelperForIpv6
{
  public:
    /**
     * Create a new SnicStackHelper which uses a mix of static routing
    ...
    /**
     * Destroy the SnicStackHelper
     */
    ~SnicStackHelper() override;

    /**
     * \brief Copy constructor
     * \param o Object to copy from.
     */
    SnicStackHelper(const SnicStackHelper& o);

    /**
     * \brief Copy constructor
     * \param o Object to copy from.
     * \returns A copy of the SnicStackHelper.
     */
     ...
     * \param c NodeContainer of the set of nodes for which the snic models
