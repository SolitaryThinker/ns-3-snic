...
main(int argc, char* argv[])
{
    ...
    csmaHelper.SetChannelAttribute("DataRate", DataRateValue(1000000000));
    csmaHelper.SetChannelAttribute("Delay", TimeValue(NanoSeconds(2)));
    ...
    SnicEchoClientHelper echoClient2(interfaces.GetAddress(0), 9);
